      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">
            {translations?.title || "Contacto"}
          </h1>
          <p className="text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
            {translations?.subtitle || "Estamos aquí para ayudarte."}
          </p>
        </div>

        <div className="max-w-4xl mx-auto space-y-12">
          {/* Sección 1: Agenda tu clase */}
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 border border-gray-100">
            <div className="text-center mb-6">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
                {translations?.calendar?.title || "Reserva tu clase"}
              </h2>
            ...
            {/* Cal.com Embed - Método más simple */}
            <div className="w-full flex justify-center">
              <div className="w-full max-w-4xl">
                <iframe
                  src="https://cal.com/clasesespanoling/clases"
                  width="100%"
                  height="600"
                  style={{
                    border: "none",
                  ...
                  title="Reserva tu clase de español"
                  loading="lazy"
                ></iframe>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-100">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-6 sm:p-8">
                <div className="mb-6">
                  ...
                  <p className="text-base text-gray-700">
                    ¿Tienes alguna pregunta específica? Completa el formulario y
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      placeholder={
                        translations?.form?.placeholder?.name ||
                        "Tu nombre completo"
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder={
                        translations?.form?.placeholder?.email || "tu@email.com"
                      }
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent"
                      required
                    />
                  ...
                  <div>
                    <label
                      ...
                      className="block text-gray-700 font-medium mb-1 sm:mb-2"
                    >
                      {translations?.form?.subject || "Asunto"}
                    </label>
                    <input
                      type="text"
                      id="subject"
                      ...
                      onChange={handleChange}
                      placeholder={
                        translations?.form?.placeholder?.subject ||
                  ...
                  <div>
                    <label
                      ...
                      className="block text-gray-700 font-medium mb-1 sm:mb-2"
                    >
                      {translations?.form?.message || "Mensaje"}
                    </label>
                    <textarea
                      id="message"
                      name="message"
                      ...
                      onChange={handleChange}
                      placeholder={
                        translations?.form?.placeholder?.message ||
                  ...
                  >
                    {formStatus === "submitting" ? (
                      <span className="flex items-center justify-center">
                        ...
                        {translations?.form?.submit || "Enviando..."}
                      </span>
                    ) : (
                      translations?.form?.submit || "Enviar mensaje"
                    )}
                  </button>
              ...
              <div className="p-6 sm:p-8 bg-gray-50 lg:rounded-r-lg">
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
                  {translations?.contact?.title || "Información de contacto"}
                </h3>
                <p className="text-sm sm:text-base text-gray-700 mb-6">
                  {translations?.contact?.description ||
                    "Contáctanos directamente si prefieres."}
                </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 mb-2 text-sm sm:text-base">
                        {translations?.contact?.social || "Síguenos en redes"}
                      </p>
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-8 sm:mb-12">
              {translations?.faq?.title || "Preguntas frecuentes"}
            </h2>
